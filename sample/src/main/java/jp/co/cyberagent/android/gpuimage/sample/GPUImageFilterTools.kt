...
object GPUImageFilterTools {
    fun showDialog(
        ...
        val filters = FilterList().apply {
            ...
            addFilter("Magnifier", FilterType.MAGNIFIER)
        }
    ...
    private fun createFilterForType(context: Context, type: FilterType): GPUImageFilter {
        return when (type) {
            ...
            FilterType.MAGNIFIER->GPUImageMagnifierFilter();
        }
    }
    ...
    private enum class FilterType {
        ...
        SPHERE_REFRACTION, SWIRL, WEAK_PIXEL_INCLUSION, FALSE_COLOR, COLOR_BALANCE, LEVELS_FILTER_MIN, BILATERAL_BLUR, ZOOM_BLUR, HALFTONE, TRANSFORM2D, SOLARIZE, VIBRANCE,MAGNIFIER
    }
